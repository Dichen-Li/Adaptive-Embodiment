...
class SuperviseActor(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs:
            print(
                "ModifiedActor.__init__ got unexpected arguments, which will be ignored: "
...
def get_policy(nr_dynamic_joint_observations: int, model_device: str):
    policy = SuperviseActor(nr_dynamic_joint_observations)
