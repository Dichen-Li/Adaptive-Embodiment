...
# TODO: Need to tune the specified parameters for humanoid. 
# Currently copy from GenHumanoidEnvCfg and only change the number of joints from 4 to 2 to enable running.
