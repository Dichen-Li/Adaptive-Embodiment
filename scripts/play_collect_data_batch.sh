...
for task in "${tasks[@]}"; do
  ...
  python scripts/rsl_rl/play_collect_data.py --task "$task" --steps 2000 --reward_log_file reward_log_file.json --min_ckpt_iter 14999 --headless "${kwargs[@]}" || stop_execution
